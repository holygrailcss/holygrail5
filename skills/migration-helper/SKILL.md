# HolyGrail 5 — Migration Helper

Asiste en la migración de proyectos existentes a HolyGrail 5.

## Contexto

HolyGrail 5 reemplaza frameworks CSS tradicionales (Bootstrap, Tailwind, CSS custom) con un sistema generado desde config.json. La migración implica mapear clases antiguas a clases HG5 y configurar el design system.
...
2. **Crea un mapa de equivalencias** entre clases antiguas y HG5:

   ### Bootstrap → HolyGrail 5
   | Bootstrap | HolyGrail 5 |
   |-----------|-------------|
   | `.d-flex` | `.hg-d-flex` |
   | `.d-none` | `.hg-d-none` |
...
4. **Plan de migración paso a paso:**
   1. Instalar: `npm install holygrail5 --save-dev`
   2. Crear config.json con los tokens del proyecto
   3. Generar CSS: `npx holygrail5`
