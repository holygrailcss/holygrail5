# HolyGrail 5 — Layout Builder

Construye layouts completos y responsive usando el sistema de grid y helpers de HolyGrail 5.

## Contexto

HolyGrail 5 ofrece un grid flexible (12-24 columnas por breakpoint), helpers de flexbox, spacing responsive y aspect ratios. Este skill combina todos estos sistemas para crear layouts de página completos.
