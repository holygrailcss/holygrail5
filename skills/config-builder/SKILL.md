# HolyGrail 5 — Config Builder

Ayuda a crear o modificar el `config.json` de HolyGrail 5 de forma correcta y completa.

## Contexto

El `config.json` es el corazón de HolyGrail 5. Define todo el design system: colores, spacing, tipografía, helpers, grid y temas. Cada propiedad genera CSS automáticamente.
...
- Ejecuta `npx holygrail5` para verificar que genera CSS sin errores
