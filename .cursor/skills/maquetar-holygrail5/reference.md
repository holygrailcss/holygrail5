# Referencia HolyGrail5 – Variables y componentes

Documento de apoyo a la skill **maquetar-holygrail5**. Detalle de variables generadas y clases de componentes del tema Dutti.
...
- `themes/dutti/_variables.css` – Tokens del tema (mapeo a --hg-*).
- `themes/dutti/_buttons.css`, `_inputs.css`, `_labels.css`, `_checkboxes.css`, `_radios.css`, `_switches.css`, `_forms.css` – Componentes.
- `themes/dutti/demo.html` – Demo; actualizar al añadir variantes o componentes.
- `themes/dutti/README.md` – Documentación del tema; mantener al día.
