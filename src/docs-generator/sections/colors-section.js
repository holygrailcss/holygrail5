  ...
  return `
          <div class="guide-color-card" data-copy-value="${eVarName}" title="Click para copiar ${eVarName}">
            ...
            <div class="guide-color-card-content">
              ...
              <div class="guide-color-class" data-copy-value=".${prefix}-c-${eKey}" title="Click para copiar .${prefix}-c-${eKey}">.${prefix}-c-${eKey}</div>
              <div class="guide-color-class" data-copy-value=".${prefix}-bg-${eKey}" title="Click para copiar .${prefix}-bg-${eKey}">.${prefix}-bg-${eKey}</div>
            </div>
          </div>`;
}
