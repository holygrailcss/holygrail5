...
function extractMeta(md) {
  ...
  for (const line of lines) {
    if (line.startsWith('# ') && !line.startsWith('## ')) {
      ...
      // Remove "HolyGrail 5 — " prefix if present
      title = title.replace(/^HolyGrail\s*5\s*[—–-]\s*/, '');
      continue;
    }
...
${themeNavLinks}
  ...
  <footer class="sk-footer">
    <p>
      HolyGrail 5 —
      <a href="https://github.com/holygrailcss/holygrail5" target="_blank">GitHub</a> ·
      <a href="https://www.npmjs.com/package/holygrail5" target="_blank">npm</a> ·
      <a href="index.html">Guía</a>
    </p>
  </footer>
